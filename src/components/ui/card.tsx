...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl bg-element-bg text-card-foreground shadow-neumorphic p-6", // Applied Neumorphic styles and padding
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("text-card-foreground  text-sm", className)} // Applied text-secondary
    {...props}
  />
))
